...
import { blockUser, getUsers, getUser, getSearchUsers, getReportedPosts, blockPost } from '../../controllers/admin/users.js';
...
router.get("/users/search/:searchName", getSearchUsers)
